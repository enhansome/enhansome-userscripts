...
* [vite-plugin-monkey](https://github.com/lisonge/vite-plugin-monkey) ⭐ 2,038 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-16 - A Vite plugin to develop and build userscripts for Tampermonkey, Violentmonkey, Greasemonkey, and ScriptCat.
...
Please have a look at [CONTRIBUTING](https://github.com/awesome-scripts/awesome-userscripts/blob/master/CONTRIBUTING.md) ⭐ 3,534 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-12 for guidelines.
